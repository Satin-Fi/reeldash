...
async function testSnapSaveDirect() {
  ...
  for (const code of shortcodes) {
    ...
    if (evalMatch) {
      ...
      console.log('Decoded HTML snippet:', decodedHtml.substring(0, 300));
      
      const thumbMatches = decodedHtml.match(/src=["']([^"']+)["']/g) || [];
      console.log('Thumbnail matches:', thumbMatches);
      const downloadMatches = decodedHtml.match(/href=["']([^"']+)["']/g) || [];
      console.log('Download matches:', downloadMatches);
    } else {
