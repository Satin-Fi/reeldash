...
async function capture() {
  ...
  // Find and click on the first reel item
  ...
  await page.screenshot({ path: 'C:/Users/Piyush/.gemini/antigravity/brain/8440ca0a-61da-4c07-a877-85f850d39e18/reel_modal_open_test.png' });
  console.log('Reel modal test captured!');
