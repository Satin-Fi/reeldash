...
async function capture() {
  ...
  // Click on the reel card directly via coordinates or selector
  await page.mouse.click(300, 450);
  await new Promise(r => setTimeout(r, 2500));

  await page.screenshot({ path: 'C:/Users/Piyush/.gemini/antigravity/brain/8440ca0a-61da-4c07-a877-85f850d39e18/reel_modal_open.png' });
  console.log('Reel modal opened screenshot captured!');
